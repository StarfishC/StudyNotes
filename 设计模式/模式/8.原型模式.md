...
public:
    ConcretePrototype1(std::string prototype_name, float concrete_prototype_filed) :
...
public:
    ConcretePrototype2(std::string prototype_name, float concrete_prototype_filed) :
