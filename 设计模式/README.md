...
_注：`设计模式`的笔记来自李建忠的设计模式课程以及《深入设计模式》一书_
...
- 创建型（Creational）模式：将对象的部分创建工作延迟到子类或者其他对象，从而应对需求变化为对象创建时具体类型实现引来的冲击  
  `包含：工厂方法模式、抽象工厂方法模式、生成器模式、原型模式、单例模式`
- 结构型（Structural）模式：通过类继承或者对象组合获得更灵活的结构，从而应对需求变化为对象的结构带来的冲击  
  `包含：适配器模式、桥接模式、组合模式、装饰模式、外观模式、享元模式、代理模式`
- 行为型（Behavioral）模式：通过类继承或者对象组合来划分类与对象间的职责，从而应对需求变化为多个交互的对象带来的冲击  
  `包含：职责链模式、命令模式、迭代器模式、中介者模式、备忘录模式、观察者模式、状态模式、策略模式、模板方法模式、访问者模式`
...
- **组件协作** 模式：
  ...
  - [模板方法模式 Template Method](./模式/1.模板方法模式.md)
...
- **对象创建** 模式：
  ...
  - [工厂方法模式 Factory Method](./模式/6.工厂方法模式.md)
  - [抽象工厂方法模式 Abstract Factory](./模式/7.抽象工厂模式.md)
